...
ENV UWSGI_INI /home/sc-api/uwsgi.ini

COPY ./sc-api /home/sc-api
WORKDIR /home/sc-api

RUN pip3 install -r /home/sc-api/requirements.txt

RUN ln -sf /usr/share/zoneinfo/Asia/Shanghai /etc/localtime \
&& echo "Asia/Shanghai" > /etc/timezone \
&& cp /home/sc-api/nginx.conf /app/ \
&& mkdir /home/static \
&& mkdir /home/logs
...
```
docker run --name=uwsgi -p 8095:9000 -v $(pwd)/home:/home  -itd sczq-uwsgi:py3.7
